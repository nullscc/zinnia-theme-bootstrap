;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="19b0d71879bd8dc007b830bfba6de6cf";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["wsAuGQoDDDlR"]={appId:"FKAQLLHf4tr5",scope:{}};;CloudflareApps.installs["wsAuGQoDDDlR"].options={"behavior":{"outMode":"bounce"},"fewerParticles":true,"interaction":{"onClick":"none","onHover":"grab"},"showAdvanced":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['wsAuGQoDDDlR'].URLPatterns)){(function(Math){var trimLeft=/^\s+/,trimRight=/\s+$/,tinyCounter=0,mathRound=Math.round,mathMin=Math.min,mathMax=Math.max,mathRandom=Math.random;function tinycolor(color,opts){color=(color)?color:'';opts=opts||{};if(color instanceof tinycolor){return color;}
...
else{window.tinycolor=tinycolor;}})(Math);};if(CloudflareApps.matchPage(CloudflareApps.installs['wsAuGQoDDDlR'].URLPatterns)){var pJS=function(tag_id,params){var canvas_el=document.querySelector("#"+tag_id+" > .particles-js-canvas-el")
...
xhr.send()}};if(CloudflareApps.matchPage(CloudflareApps.installs['wsAuGQoDDDlR'].URLPatterns)){"use strict";(function(){if(!window.addEventListener)return;var _window=window;var tinycolor=_window.tinycolor;var CONTAINER_ID="eager-particles-js";var getComputedStyle=document.defaultView.getComputedStyle.bind(document.defaultView);var options=CloudflareApps.installs['wsAuGQoDDDlR'].options;var element=void 0;function getParticleColor(){var particleColor=void 0;if(options.particleColor){particleColor=tinycolor(options.particleColor);}else{var backgroundColor=options.backgroundColor||getComputedStyle(document.body).backgroundColor;var components=tinycolor(backgroundColor).toHsl();components.l=Math.abs((components.l+0.5)%1)+(1-components.s)*0.1;particleColor=tinycolor(components);}
...
window.CloudflareApps.installs['wsAuGQoDDDlR'].scope={setColors:function setColors(nextOptions){options=nextOptions;if(!window.pJSDom){updateElement();return;}
